...
class NegociosPorCategoria extends Component{

    static navigationOptions = ({ navigation }) => ({
      headerTitle: navigation.state.params.subcategoriaNombre,
      headerRight: null,
        ...
        <View style={styles.containerList}>
          <View style={styles.sliderStyle}>
            <Swiper
              ...
              >
                {this.props.navigation.state.params.imagenBannerUrl.map((item, i) => <Slider
